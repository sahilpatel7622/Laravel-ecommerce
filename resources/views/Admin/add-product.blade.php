        ...
        <form action="{{ route('admin.products.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea id="description" name="description" rows="5" placeholder="Enter full product description..." class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border" required>{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
